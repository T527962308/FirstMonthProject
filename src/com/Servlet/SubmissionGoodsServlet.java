...
public class SubmissionGoodsServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            int result = goodsinfoDao.reviseGoods(goodsinfo);
            ...
            if(result > 0){
                ...
                out.println("<script type='text/javascript'>alert('修改成功');location.href='HomePage.jsp';</script>");
            }else {
            ...
            if(fileItemList != null && fileItemList.size() > 0){
                ...
                for(FileItem b : fileItemList){
                    ...
                    if(b.isFormField()){
                        ...
                        if("id".equals(b.getFieldName())){
                            goodsinfo.setId(Integer.parseInt(b.getString()));
                        } else if("name".equals(b.getFieldName())){
                            goodsinfo.setGoodsinfoName(b.getString("utf-8"));
                        } else if("pic".equals(b.getFieldName())){
                            goodsinfo.setGoodsinfoPic(b.getString("utf-8"));
